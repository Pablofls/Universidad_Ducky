        ...
        if (_selectedBook != null)
          _BookDetailModal(
            ...
            copies: MockData.copies.where((c) =>
                ...
                c.status == CopyStatus.available).toList(),
...
class _BookDetailModal extends StatelessWidget {
  ...
  const _BookDetailModal({required this.book, required this.copies, required this.onClose});
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Flexible(child: SingleChildScrollView(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    // Info grid
                    Row(children: [
                      Expanded(child: _InfoCell('ISBN', book.isbn)),
                      Expanded(child: _InfoCell('Tema', book.topic)),
                    ]),
                    const SizedBox(height: 12),
                    Row(children: [
                      Expanded(child: _InfoCell('Editorial', book.publisher)),
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    if (copies.isNotEmpty) ...[
                      ...
                      const SizedBox(height: 12),
                      Row(children: [
                        const Icon(LucideIcons.mapPin, size: 15, color: Color(0xFF374151)),
                        const SizedBox(width: 6),
                        const Text('Ubicación', style: TextStyle(
                            fontSize: 14, fontWeight: FontWeight.w700, color: Color(0xFF111827))),
                      ]),
                        ...
                        child: Row(children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(20)),
                            child: const Text('Disponible', style: TextStyle(
