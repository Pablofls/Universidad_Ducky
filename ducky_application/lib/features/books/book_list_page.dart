...
class _BookListPageState extends State<BookListPage> {
  ...
  void _exportToPrint() {
    ...
    final dateStr = '${now.day} de ${_monthName(now.month)} de ${now.year}';
    ...
    final rows = filtered.map((b) => '''
      <tr>
        ...
        <td style="color:${b.availableCopies == 0 ? '#EF4444' : b.availableCopies <= 2 ? '#F59E0B' : '#0E7334'};font-weight:600">${b.availableCopies}</td>
        <td>${b.totalCopies}</td>
      </tr>''').join('');
...
<style>
  ...
  th{background:#0E7334;color:white;padding:7px 6px;text-align:left;font-weight:600;font-size:10px;letter-spacing:.4px}
...
<div class="sub">Catalogo de Libros - Sistema de Gestion de Biblioteca</div>
...
<table>
<tr><th>ISBN</th><th>TITULO</th><th>AUTOR</th><th>TEMA</th><th>SECCION</th><th>EDITORIAL</th><th>PRECIO</th><th>DISP.</th><th>TOTAL</th></tr>
$rows
</table>
<div class="footer">Este documento fue generado automaticamente por el Sistema de Gestion de Biblioteca de la Universidad Ducky.</div>
</body></html>''';
  ...
  String _monthName(int m) => const ['', 'enero','febrero','marzo','abril','mayo','junio',
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          _ActionBtn(icon: LucideIcons.eye,        label: 'Ver',    onTap: () => context.go('/books/${book.isbn}')),
          const SizedBox(width: 4),
          _ActionBtn(icon: LucideIcons.edit2,      label: 'Editar', onTap: () => context.go('/books/${book.isbn}/edit')),
          const Spacer(),
      ...
      child: Row(children: [
        ...
        Expanded(flex: 2, child: Row(children: [
          IconButton(padding: EdgeInsets.zero, constraints: const BoxConstraints(),
              ...
              onPressed: () => context.go('/books/${book.isbn}')),
